...
const UniversityCard = memo(({ f, setSelectedUniversity, neumorphicShadow, neumorphicPressedShadow, darkMode, itemVariants }) => {
  return (
    <motion.div
      key={f.name}
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        <div
          className={`px-3 py-1 rounded-full text-sm font-medium flex items-center ${
            darkMode ? "bg-slate-700 text-cyan-400" : "bg-gray-100 text-cyan-600"
          }`}
          style={{ boxShadow: neumorphicShadow }}
        >
          <svg
